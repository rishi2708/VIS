...
<html lang="en">
    ...
    <body>
        ...
        <sql:query dataSource="${dataSource}" var="rs">
            SELECT vehicles.*, users.phone FROM vehicles LEFT JOIN users on vehicles.owner = users.username WHERE vehicles.status = 'For Sale';
        </sql:query>
        ...
        <c:import url="includes/header.jsp" >
            <c:param name="title" value="purchaseVehicle" />
        </c:import>
